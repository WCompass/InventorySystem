    ...
    <form id="form1" runat="server">
        <div>
            <dl>
                ...
                <dt>
                    <asp:Button ID="btnEdit" runat="server" Text="修改" OnClick="btnEdit_Click" />&nbsp;<asp:Button ID="btnBack" runat="server" Text="返回" OnClick="btnBack_Click" />&nbsp;<asp:Button ID="btnDelete" runat="server" Text="删除" OnClick="btnDelete_Click" /></dt>
            </dl>
        </div>
    </form>
</body>
